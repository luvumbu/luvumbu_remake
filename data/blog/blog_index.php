...
<body id="content">
  ...
  require_once "blog_index_styles.php";
  require_once "blog_index_menu_1.php";
  require_once "blog_index_section_0.php";
  require_once "blog_index_articles_1.php";
  require_once "all_profil_user/" . $id_sha1_user_projet . ".php";
  require_once "blog_index_profil_1.php";
  require_once "blog_index_footer_1.php";
  ?>
</body>
