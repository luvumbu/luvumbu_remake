...
<body>
    ...
    <form method="post" action="submit.php">
        ...
        <div class="field-container" id="container-1">
            <div class="display_flex">
              ...
              ?>
                ...
                ?>
                            ...
                            <option class="<?= $dynamicVariables['id_style_page'][$i_y] ?>"
                                value="<?= $dynamicVariables['id_style_page'][$i_y] ?>">
                                <?= AsciiConverter::asciiToString($dynamicVariables['name_style_page'][$i_y]) ?>
                            </option>
                ...
                //$id_projet_style
                ?>
                            <option selected class="<?= $index_of_style[$index] ?>"
                                value="<?= $index_of_style[$index] ?>">
                                <?= AsciiConverter::asciiToString($dynamicVariables['name_style_page'][$index]) ?>
                            </option>
            ...
            <div>
                <input value="<?= $password_projet ?>" type="text" title="<?= $_SESSION["index"][4] ?>"
                    class="update_function_password" onkeyup="update_function_password(this)"
                    placeholder="Mot de passe pour la page">
            </div>
        ...
        <div class="field-container" id="container-5">
          ...
          ?>
                ...
                ?>
                        <img class="cursor_pointer" id="<?= 'active_' . $id_sha1_projet_img_c[$i__] ?>"
                            onclick="change_img_active(this)" title="<?= $id_projet_img_c[$i__] ?>" width="40"
                            height="40" src="<?= $img_1__ ?>" alt="unchecked-checkbox" />
          ...
          ?>
              ...
              ?>
                ...
                <div>
                    ...
                    <div>
                        <b>Début</b>
                        <input type="date" title="<?= $id_sha1_projet__ ?>" value="<?= $date_debut_projet ?>"
                            id="date_gene_debut" onchange="update_date_general_df(this)">
                    </div>
                    <div>
                        <b>Fin</b>
                        <input type="date" title="<?= $id_sha1_projet__ ?>" value="<?= $date_fin_projet ?>"
                            id="date_gene_fin" onchange="update_date_general_df(this)">
                    </div>
...
<div class="cursor_pointer terminer" onclick="terminer(this)">
    <img width="100" height="100"
        src="https://img.icons8.com/external-microdots-premium-microdot-graphic/100/external-finish-sport-fitness-vol2-microdots-premium-microdot-graphic-2.png"
        alt="external-finish-sport-fitness-vol2-microdots-premium-microdot-graphic-2" alt="checkmark--v1" />
</div>
