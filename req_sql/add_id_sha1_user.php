...
$date_inscription_user = $time_date ; 
...
$databaseHandler->action_sql("INSERT INTO  `profil_user` (`id_sha1_user`, `id_parent_user`,`nom_user`,`date_inscription_user`) VALUES ( '$id_sha1_user_id', '$id_parent_user','$nom_user','$date_inscription_user');");
