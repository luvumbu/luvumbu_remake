...
"header_html_pages_projet" => "LONGTEXT NOT NULL",
"header_css_pages_projet" => "LONGTEXT NOT NULL",
"header_js_pages_projet" => "LONGTEXT NOT NULL",
"header_sql_pages_projet" => "LONGTEXT NOT NULL",
"header_src_pages_projet" => "LONGTEXT NOT NULL",


"section_html_pages_projet" => "LONGTEXT NOT NULL",
"section_css_pages_projet" => "LONGTEXT NOT NULL",
"section_js_pages_projet" => "LONGTEXT NOT NULL",
"section_sql_pages_projet" => "LONGTEXT NOT NULL",
"section_src_pages_projet" => "LONGTEXT NOT NULL",


"section_child_html_pages_projet" => "LONGTEXT NOT NULL",
"section_child_css_pages_projet" => "LONGTEXT NOT NULL",
"section_child_js_pages_projet" => "LONGTEXT NOT NULL",
"section_child_sql_pages_projet" => "LONGTEXT NOT NULL",
"section_child_src_pages_projet" => "LONGTEXT NOT NULL",


"footer_html_pages_projet" => "LONGTEXT NOT NULL",
"footer_css_pages_projet" => "LONGTEXT NOT NULL",
"footer_js_pages_projet" => "LONGTEXT NOT NULL",
"footer_sql_pages_projet" => "LONGTEXT NOT NULL",
"footer_src_pages_projet" => "LONGTEXT NOT NULL",
