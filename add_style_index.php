...
<body>
    ...
    <form action="submit_style.php" method="post">
        ...
        <input
            ...
            type="text"
            id="name_style_page"
            name="name_style_page"
            placeholder="Entrez le nom du style"
            value="<?php echo isset($_SESSION['select_style']) ? htmlspecialchars($dynamicVariables['name_style_page'][0]) : ''; ?>"
            required>
        ...
        <textarea
            id="info_style_page"
            name="info_style_page"
            placeholder="Informations sur le style"
            rows="4"
            required><?php echo isset($_SESSION['select_style']) ? htmlspecialchars($dynamicVariables['info_style_page'][0]) : ''; ?></textarea>

        <div id="info_style_page_info" role="alert"></div>
        <label for="text_style_page">text_style_page:</label>
        <textarea
            id="text_style_page"
            name="text_style_page"
            placeholder="Texte associé au style"
            rows="4"
            required><?php echo isset($_SESSION['select_style']) ? htmlspecialchars($dynamicVariables['text_style_page'][0]) : ''; ?></textarea>
    ...
    <script>
        function add_style(_this) {
            ...
            if (name_style_page_bool && info_style_page_bool && text_style_page_bool) {
                ...
                document.getElementById("id_user_style_page").innerHTML = '<div class="alert alert-success" role="alert">Le formulaire a été envoye avec succes redirection dans 1 seconces</div>';
