...
for ($i = 0; $i < count($info_plus_1_send_mail_x); $i++) { 
  ...
  $plus =' <textarea class="text_area_info"  title="'.$id_send_mail_x[$i].'" name="" id=""></textarea>
  <div title="'.$id_send_mail_x[$i].'" onclick="info1(this)" class="add_info">add_info</div>
<div title="'.$id_send_mail_x[$i].'" onclick="info2(this)" class="voir_info">voir info</div>';
 ...
 <style>
  ...
  <?php 
    $sentMails[] = [
        ...
        "subject" => "", 
        "body"    => formatMailTextToHtml(AsciiConverter::asciiToString($text_send_mail_x[$i])).' '.$plus,
...
<body>
  <div class="app">
    <aside class="sidebar">
      <!-- Sidebar simplifiée : juste le titre -->
      <div class="brand">
  ...
  <a href="index.php">
<img width="50" height="50" src="https://img.icons8.com/material-outlined/50/home--v2.png" alt="home--v2"/>
  </a>
 <a href="mail_programe.php">
  <img width="50" height="50" src="https://img.icons8.com/cotton/50/mail.png" alt="mail"/>
 </a>
