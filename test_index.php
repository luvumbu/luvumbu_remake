...
<body>
    ...
    <nav id="navbar">
        <div class="nav-container">
            <a href="#home" class="logo-link">
                ...
                <span class="logo-text"><?= AsciiConverter::asciiToString($title_projet[0]) ?></span>
            </a>
            <ul class="nav-links" id="navLinks">
                ...
                ?>
                    ...
                    <li><a href="#<?= $id_sha1_projet_a[$i] ?>" class="nav-link"><?= AsciiConverter::asciiToString($title_projet_a[$i]) ?></a></li>
                <?php
                }
        ...
        <div class="hero-content">
            <div class="text-rotator">
                <div class="text-set active">
                    <h1 class="glitch-text" data-text="<?= AsciiConverter::asciiToString($google_title_projet[0]) ?>"><?= AsciiConverter::asciiToString($google_title_projet[0]) ?></h1>
                    <p style="text-align: justify;" class="subtitle"><?= AsciiConverter::asciiToString($description_projet[0]) ?></p>
                </div>
                <div class="text-set">
    ...
    <section class="about" id="about">
        ...
        <?php
for ($i=0; $i < count($google_title_projet_a); $i++) { 
 $title_projet_a_ = replace_element_2(AsciiConverter::asciiToString($title_projet_a[$i]));

 $description_projet_a_ = replace_element_2(AsciiConverter::asciiToString($description_projet_a[$i]));
 


?>
        <div class="about-content" id="<?= $id_sha1_projet_a[$i] ?>">
            <div class="about-text">
                <h2><?=  $title_projet_a_ ?></h2>
                <p><?=  $description_projet_a_?></p>
